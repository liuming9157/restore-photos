    ...
    return (
        <main
            ...
            <div
                ...
                <p>
                    Welcome to 55AI, accessible from 55ai.store. Please read these Terms
                    of Service ("Terms", "Terms of Service") carefully before using the 55AI web
                    application ("Service").
                </p>
                ...
                <p>
                    <ul className="list-inside list-disc">
                        ...
                        <li>
                            55AI has the right, but not the obligation, to monitor and review any
                ...
                <p>
                    All content, features, and functionality of the Service are owned by 55AI, its
                ...
                <p>
                    The Service is provided on an "as is" and "as available" basis. 55AI makes no
                ...
                <p>
                    In no event shall 55AI, nor its directors, employees, partners, or agents, be
